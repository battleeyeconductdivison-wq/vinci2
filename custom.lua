...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("vinci.lol | Security : You are running another script, please disable it and execute again")
    end
end
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "South Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgba(172, 7, 7, 1)">vinci.</font>lol\n' .. Title
                    ...
                    task.spawn(function()
                        ...
                        while tick() < endTime do
                            ...
                            textLabel.Text = string.format(
                                '<font color="rgb(172, 7, 7)">vinci.</font>lol\n%s\nplease wait : <font color="rgb(172, 7, 7)">%.2f</font> seconds',
        ...
        if Game_Name == "The Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Font = Enum.Font.SourceSansBold
                textLabel.RichText = true
                textLabel.Text = '<font color="rgba(172, 7, 7, 1)">bronx.</font>lol\n' .. Title
                textLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
                textLabel.BackgroundTransparency = 1
                textLabel.TextSize = 36
                textLabel.TextStrokeTransparency = 0.8 
                ...
                if Timing then
                    task.spawn(function()
                        ...
                        while tick() < endTime do
                            ...
                            textLabel.Text = string.format(
                                '<font color="rgb(172, 7, 7)">bronx.</font>lol\n%s\nplease wait : <font color="rgb(172, 7, 7)">%.2f</font> seconds',
                                Title, math.max(timeLeft, 0)
                            )
...
local window = library:window({name = "vinci", suffix = ".lol", gameInfo = string.format("vinci.lol : %s", Game_Name:lower())})
