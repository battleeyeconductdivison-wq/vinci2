        ...
        section:button({
            ...
            callback = function()
                ...
                if not isfolder then
                    notify("Executor doesn't support isfolder/OS folder access.")
                    return
                end
                ...
                if not success then
                    notify("Failed to open folder, your executor might not support this.")
                else
                    notify("Opened Config Folder: " .. folderPath, 4)
                end
            end
        })
